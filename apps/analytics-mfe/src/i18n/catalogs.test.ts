...
describe('i18n catalogs', () => {
  it('exposes the same key set for every supported language', () => {
    for (const catalogs of [COPILOT_CATALOGS, DEVICE_CATALOGS, WEBSITE_CATALOGS, KPI_CATALOGS, PROOF_CATALOGS]) {
  ...
  it('keeps interpolation placeholders identical across languages', () => {
    ...
    for (const catalogs of [DEVICE_CATALOGS, KPI_CATALOGS, PROOF_CATALOGS]) {
