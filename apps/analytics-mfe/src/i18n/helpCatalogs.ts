...
import { HELP_SECTION } from './helpSectionMessages'
import { languageOf } from './messages'

const EN: HelpCatalog = { ...HELP_EN, ...HELP_DIAGRAM.en, ...HELP_KNOWLEDGE.en, ...HELP_SECTION.en }
const FR: HelpCatalog = { ...HELP_FR, ...HELP_DIAGRAM.fr, ...HELP_KNOWLEDGE.fr, ...HELP_SECTION.fr }
const DE: HelpCatalog = { ...HELP_DE, ...HELP_DIAGRAM.de, ...HELP_KNOWLEDGE.de, ...HELP_SECTION.de }
const NL: HelpCatalog = { ...HELP_NL, ...HELP_DIAGRAM.nl, ...HELP_KNOWLEDGE.nl, ...HELP_SECTION.nl }
const ES: HelpCatalog = { ...HELP_ES, ...HELP_DIAGRAM.es, ...HELP_KNOWLEDGE.es, ...HELP_SECTION.es }
