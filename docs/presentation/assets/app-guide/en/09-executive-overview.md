...
1. The shell shows site, persona, search, Fabric capacity, the BFF connection pill and language; the purple banner warns that data is synthetic and not for operational control (`apps\portal-shell\README.md`; `docs\README.md`).
