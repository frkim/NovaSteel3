...
1. Le shell affiche site, persona, recherche, capacité Fabric, la pastille de connexion BFF et langue ; la bannière violette rappelle que les données sont synthétiques et non opérationnelles (`apps\portal-shell\README.md`; `docs\README.md`).
