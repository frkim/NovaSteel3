...
3. **Barre de progression** pour le total, accompagnée de la phrase *"Self-assessed against docs/usecase/rating_grid.md. Every score below 5 states its gap and the work that would close it."* avec deux liens GitHub : **rating_grid.md** et **Full analysis** (`RUBRIC_URL` dans `TechnicalRequirements.tsx`).
