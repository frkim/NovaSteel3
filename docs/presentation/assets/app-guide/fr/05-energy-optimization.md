...
10. **Note sous les boutons.** L'écran précise qu'aucune action UI n'écrit un planning opérationnel et que l'approbation est simulée/shadow pendant la démonstration et le pilote (`apps\analytics-mfe\src\components\screens\EnergySimulator.tsx:127-129`).
