...
| File | Role |
|---|---|
| `slides.md` | The deck source. 37 timed slides for a 38-minute talk plus 14 FAQ/appendix backup slides. |
...
- Every content slide carries exactly one speaker note comment that starts with a
  ...
  fails the build if the 37 main slides do not add up to a 38-minute talk. Backup and
