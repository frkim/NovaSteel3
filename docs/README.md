...
| Data/Fabric | [Synthetic data](data/synthetic-data-and-simulators.md), [Fabric README](../fabric/README.md), [Fabric research](research/fabric-platform.md), [Fabric accelerator evaluation](data/fabric-accelerator-evaluation.md) |
